...
<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
    ...
    <form
        ...
        <div class="input-group">
            <input type="text" class="form-control bg-light border-0 small" placeholder="Chercher un article" aria-label="Search" aria-describedby="basic-addon2">
            <select name="table" class="form-select form-control bg-light border-0 small " aria-label="Disabled select example">
